...
function get_course_details($id)
{
    ...
    if ($stmt = $conn->prepare("SELECT course_id, course_title, course_price, course_description, course_curriculum_brief, course_aim, course_objectives, course_salient_features, course_entry_criteria, course_structure_downloadable, course_structure_details, course_url , enrollment_count FROM courses WHERE course_id = ?")) {
                        ...
                        <section class="my-20 space-y-6 sticky md:top-8 shadow-lg rounded-xl p-8 w-full md:basis-1/3">
                            ...
                            <div class="text-gray-600 space-y-4">
                                <div id="includes" class="space-y-4">
                                    ...
                                    <p> Price: ' . ($c_price !== 0 ? number_format($c_price) : "Free") . '</p>
