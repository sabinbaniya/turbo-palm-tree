            ...
            <section class="py-20">
                ...
                <section class="my-10">
                    <form action="../../controllers/user/settings/edit-profile-details.php" method="POST" class="bg-white p-8 space-y-8 rounded-lg max-w-lg mx-auto" id="update_form">
                        ...
                        <div>
                            <input disabled name="update" id="btn" type="submit" value="Update" class="cursor-not-allowed w-full bg-blue-300 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-400">
                            <div class="my-4">
