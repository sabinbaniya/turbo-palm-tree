                    ...
                    <section class="max-w-[1400px] mx-auto px-8 flex flex-col md:flex-row justify-between items-start">
                        <section class="basis-1/2">
                            ...
                            <section class="my-20 space-y-6 text-gray-600">
                                ...
                                <div class="changeList space-y-6">
                                <p>After completion of this training, the trainees will be</p><ol><li>Proficient in English Typing</li><li>Proficient in Nepali Typing</li></ol>
                                </div>
                            ...
                            <section class="my-20 space-y-6 text-gray-600">
                                ...
                                <div>
                                    <div class="space-y-2 changeList">
                                        <p><strong>Entry Criteria</strong></p><p>Individuals who meet the following criteria will be allowed to enter this curricular program:</p><p>Minimum of SEE/SLC pass</p><p>Nepali citizen</p><p>Minimum of 16 years of age</p>
                                    </div>
                                </div>
                            </section>
                        ...
                        <section class="my-20 space-y-6 sticky md:top-8 shadow-lg rounded-xl p-8 w-full md:basis-1/3">
                            ...
                            <div class="text-gray-600 space-y-4">
                                <div id="includes" class="space-y-4">
                                    <p>English Typing</p><p>Nepali Typing</p>
                                    <p> And all the curriculum listed here </p>

                                </div>
                                <button class="w-full inline-block">
                                    <a href="./enroll.php?id=2197873813695" class="bg-blue-500 font-bold text-white text-xl px-4 py-2 w-full inline-block rounded-xl hover:bg-blue-400 focus:ring-4 ring-blue-200">Enroll Now</a>
                                </button>
                            </div>
                        </section>
                    </section>
