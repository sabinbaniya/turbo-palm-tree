...
<body class="scroll-smooth">
    ...
    <section class="px-8 mx-auto max-w-[1400px]">
        <section class="my-16 flex items-center justify-evenly">
            <h1 class="text-7xl font-bold leading-[80px]">Courses for</br> Everyone</h1>
            <div class="space-y-4">
                <p class="text-gray-700 text-xl">Take any of our free online courses to<br /> add more skills to your skillset.</p>
                <a href="./courses.php" class="inline-block">
                    <button class="bg-blue-500 text-bold text-white rounded-tl-xl rounded-br-xl px-6 py-4 font-bold hover:rounded-tr-xl hover:rounded-bl-xl hover:-translate-y-1 transition-all">View Courses</button>
                </a>
            </div>
        </section>
        <section class="my-16">
            <h3 class="text-center text-3xl font-bold">See what we've to offer</h3>
            <section class="my-8 flex items-center justify-between overflow-x-hidden no-wrap space-x-4" id="course-slider">
                <section class="my-8 flex items-center justify-between no-wrap space-x-4">
                    <div class="rounded-xl bg-blue-400 text-white p-8 space-y-4 flex-shrink-0 w-80">
                    ...
                    <div class="rounded-xl bg-emerald-400 text-white p-8 space-y-4 flex-shrink-0 w-80">
                    ...
                    <div class="rounded-xl bg-orange-400 text-white p-8 space-y-4 flex-shrink-0 w-80">
                    ...
                    <div class="rounded-xl bg-indigo-400 text-white p-8 space-y-4 flex-shrink-0 w-80">
                    ...
                    <div class="rounded-xl bg-amber-400 text-white p-8 space-y-4 flex-shrink-0 w-80">
                    ...
                    <div class="rounded-xl bg-lime-400 text-white p-8 space-y-4 flex-shrink-0 w-80">
