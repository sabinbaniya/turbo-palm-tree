...
const gender_icon = document.querySelector("#gender_icon");
...
form.addEventListener("submit", (e) => {
  ...
  gender_icon.classList.remove("invalid_input_icon");
  ...
  gender_icon.classList.add("valid_input_icon");
  ...
  const number_val = document.querySelector("#number").value;
  const birthdate_val = document.querySelector("#birth-date").value;
  let errors_count = 0;
